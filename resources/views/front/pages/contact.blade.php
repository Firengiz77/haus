...
@section('title'){{ $meta->contact_meta_title }}@endsection
@section('desc'){{ $meta->contact_meta_desc }}@endsection
@section('keyw'){{ $meta->contact_meta_keyw }}@endsection
        ...
        <div class="row">
            <div class="col-lg-6 align-self-center mb-5 mb-lg-0">
                <div class="contact-left">
                    ...
                    <form id="ajax-form" action="{{ route('send_form') }}" method="post" class="wpcf7">
                        @csrf
                        <div class="main-form">
                            <p>
