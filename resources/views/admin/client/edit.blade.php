 ...
 .a_remove3{
  ...
  margin-bottom:10px;
          ...
          <div class="content-wrapper">
            ...
            @if($client !== null)    
           <form action="{{route('admin.client_update',$client->id)}}" method="post" enctype="multipart/form-data" >
            @csrf
           <div class="form-group">

                <div class="mb-3 col-md-12 ">
                  <label for="desc_1" class="form-label">{{ __('alt') }} :</label>
                  <input  class="form-control" type="text" name="alt" value="{{ $client->alt }}"> 
                </div>
      ...
      @endif
              ...
              <div class="card">
                ...
                @if($client !== null)
                    ...
                    <div class="col-md-3" >
                        <div class="image-box">
                            <img src="{{ asset('uploads/client/' . $images) }}" width="150" alt="">
                           <div id="newform24" class='a_remove2_{{$key}}'>
                            <button type="button" data_id="{{$key}}" class="a_remove3 btn btn-primary me-2" onclick="delete_images('{{route('admin.delete_images_gallery',$client->id)}}','{{ $key }}')"  id="{{ $key }}" >
