...
@section('container')
  ...
  <div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
      <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Admin /</span> Language</h4>
      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          ...
          <form enctype="multipart/form-data" id="formAccountSettings" method="POST" action="{{ route('admin.language_add') }}">
            @csrf
                 ...
                 <div class="container">
                  ...
                  <div class="mb-3 col-md-12 ">
                   ...
                   <button type="submit" class="btn btn-outline-secondary account-image-reset mb-4">
                     ...
                     <span class="d-none d-sm-block">Add Language</span>
                   </button>
