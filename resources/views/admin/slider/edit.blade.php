...
<link rel="stylesheet" href="{{ asset('/admin/assets/css/choise.css')}}">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Admin /</span> {{ __('service') }} </h4>
              ...
              <div class="row mb-5">
                <div class="col-md-4 col-lg-2 mb-3 card-body" style="border:1px solid #a1acb8;border-radius:8px">
                  ...
                  @endif
                    <form enctype="multipart/form-data" id="formAccountSettings" method="POST" action="{{ route('admin.slider_update',$slider) }}">
                        @csrf
                        ...
                        <div class="col-md-12">
                                ...
                                <div class="mb-3 col-md-12 ">
                                  ...
                                  <input  class="form-control" type="text" name="alt" value="{{ $slider->alt }}"> 
                                </div>
                          ...
                          <div class="mb-3 col-md-12 ">
                            ...
                            <textarea name="desc"   class="form-control" cols="30" rows="10">  {!! $slider->desc !!}</textarea>
                          </div>

                          <div class="mb-3 col-md-12 ">
                            <label for="desc_1" class="form-label">{{ __('content') }} 2:</label>
                            <textarea name="desc_1"   class="form-control" cols="30" rows="10">  {!! $slider->desc_1 !!}</textarea>
                          </div>
