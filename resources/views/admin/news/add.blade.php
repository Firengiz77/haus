    ...
    <div class="container-xxl flex-grow-1 container-p-y">
      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          ...
          <form enctype="multipart/form-data" id="formAccountSettings" method="POST" action="{{ route('admin.blog_add') }}">
            @csrf
             <div class="d-flex align-items-start align-items-sm-center gap-4">
                 ...
                 <div class="mb-3 col-md-12 ">
                  ...
                  <div class="mb-3 col-md-12">
                    ...
                    <textarea name="desc"  required  class="form-control" id="editor9" cols="30" rows="10"></textarea>
