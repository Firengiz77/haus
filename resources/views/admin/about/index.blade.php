...
@section('container')
          ...
          <div class="content-wrapper">
            ...
            <div style="display: flex;align-items: baseline;flex-direction: row;justify-content: space-between;">
              ...
              {{-- <a class="btn btn-success" href="{{ route('admin.about_show') }}"> {{ __('about_blog') }} </a> --}}
              ...
              <div class="card">
                ...
                <div class="table-responsive text-nowrap">
                 ...
                 @foreach($about as $key => $item )
                      <tr>
                        <td>{{ ++$key }}</td>
                <!--         <td>   <img style="width: 80px; object-fit:cover" src="{{ asset($item->image) }}"
                                            alt=""> </td>
                                            -->
                        <td>
                        ...
                        <td>
                          <a href="{{ route('admin.about_edit',$item->id) }}" class="btn btn-outline-primary">{{ __('edit') }}</a>
                        </td>
                      </tr>
