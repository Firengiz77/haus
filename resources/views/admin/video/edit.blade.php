            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="row mb-5">
                <div class="col-md-4 col-lg-2 mb-3 card-body" style="border:1px solid #a1acb8;border-radius:8px">
                  ...
                  @endif
                    <form enctype="multipart/form-data" id="formAccountSettings" method="POST" action="{{ route('admin.video_update',$link) }}">
                        @csrf

                   
                    
                          <div class="mb-3 col-md-12 ">
                            <label for="desc" class="form-label">{{ __('link') }} :</label>
                            <textarea name="link" class="form-control"  cols="30" rows="10">  {!! $link->link !!}</textarea>
                          </div>
