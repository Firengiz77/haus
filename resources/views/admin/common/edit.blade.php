            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="row mb-5">
                <div class="col-md-4 col-lg-2 mb-3 card-body" style="border:1px solid #a1acb8;border-radius:8px">
                  ...
                  @endif
                    <form enctype="multipart/form-data" id="formAccountSettings" method="POST" action="{{ route('admin.common_update',$common) }}">
                        @csrf
                        ...
                        <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <img style="width: 80px; object-fit:cover" src="{{ asset($common->icon1) }}"
                                            alt="">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        <label>{{ __('current_thumbnail') }}:</label>
                                        <img style="width: 80px; object-fit:cover" src="{{ asset($common->icon2) }}"
                                            alt="">
                                    </div>
                                </div>
